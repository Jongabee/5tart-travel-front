...
const Reportes: React.FC = () => {
    ...
    const fetchNotifications = async () => {
      try {
        const response = await axios.get(
          ...
          // 'https://fivetart-travel-kafg.onrender.com/contact'
        );
  ...
  const sendMessage = async (id: string) => {
    try {
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/sendEmail/${id}`,

        // `https://fivetart-travel-kafg.onrender.com/contact/sendEmail/${id}`,
      );
      Swal.fire({
        icon: 'success',
  ...
  const deleteMessage = async (id: string) => {
    try {
      await axios.delete(
        ...
        // `https://fivetart-travel-kafg.onrender.com/contact/${id}`,
      );
      setNotifications(
